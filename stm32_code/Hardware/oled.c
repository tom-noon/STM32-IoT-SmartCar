...
void OLED_Init(void)
{
	...
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;//速度50MHz
 	HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);	  //初始化GPIOG12
 	OLED_SCL_Set();
	
	GPIO_InitStruct.Pin = GPIO_PIN_1|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_15;
 	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP; 		 //推挽输出
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;//速度50MHz
 	HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);	  //初始化GPIOD1,5,15
 	OLED_SDA_Set();OLED_RES_Set();
	OLED_DC_Set();OLED_CS_Set();
	
	GPIO_InitStruct.Pin = GPIO_PIN_8|GPIO_PIN_10;
 	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP; 		 //推挽输出
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;//速度50MHz
 	HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);	  //初始化GPIOE8,10
